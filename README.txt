...
I am not an expert coder, but this program I believe can be useful for many applications, and is fairly simple to implement and understand. If anyone wants to chip in, I would appreciate the input, as I am new to Git.